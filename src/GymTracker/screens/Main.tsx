...
export default function Main(){
    ...
    useEffect(() => {
      // Call scrollToEnd after the component mounts (or content updates)
                ...
                <ImageBackground 
                    ...
                    <View className="absolute top-1/2 h-1/2 w-full flex flex-row justify-between items-end p-5">
                        <View className="justify-center w-3/5">
                            ...
                            <Text className="text-white text-md">Seu ultimo treino de perna foi dia 14/04</Text>
                        </View> 
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <View className="w-6 h-6">
                                        <View 
                                            className={clsx("h-full w-full items-center justify-center rounded-full", 
                                            {
